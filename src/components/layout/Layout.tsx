    ...
    return (
        <LayoutWrapper>
                    ...
                    <Nav role="navigation" aria-label="Main navigation">
                        <div className="container">
                            ...
                            <NavLinks open={menuOpen} role="list">
                                ...
                                <a href="#contact" role="listitem" aria-label="Contact section">{t('navigation.contact')}</a>
                                <LanguageToggle/>
                            </NavLinks>
                        </div>
                    </Nav>
            ...
            <Footer role="contentinfo">
                <div className="container">
                    <p>© {new Date().getFullYear()} Radin Ghareh Baghi Pouri. {t('navigation.footer-rights')}.</p>
                </div>
            </Footer>
        </LayoutWrapper>
    );
